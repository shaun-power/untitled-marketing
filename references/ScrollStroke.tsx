...
/**
 * Reference component — Skiper19 scroll-progress SVG stroke
 * Adapted from https://skiperui.com
 *
 * Key technique:
 * - useScroll tracks scroll progress of a tall container
 * - useTransform maps scroll progress to SVG pathLength
 * - motion.path animates the stroke drawing
 *
 * For Trellis: replace the decorative swooping path with a
 * graph/network-shaped path (nodes + branching connections)
 */
